...
class Four_Seasons_Hotel extends StatelessWidget {
  const Four_Seasons_Hotel({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://cdn.kiwicollection.com/media/property/PR005341/xl/005341-04-Room-Four-Seasons-Alexandria-at-San-Stefano.jpg?cb=1561668823',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://media-cdn.tripadvisor.com/media/photo-s/15/20/ef/97/san-stefano-four-season.jpg'
                            ),
                            fit: BoxFit.fill),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://ar-ar.facebook.com/FourSeasonsHotelAlexandria/");
                      //https://m.facebook.com/profile.php?id=139340932872218&__tn__=C-R
                    }, icon: Icon(Icons.facebook)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("tel:035818000");
                      //02 24619494
