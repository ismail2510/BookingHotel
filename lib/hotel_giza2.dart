...
class Giza_Pyramids_Inn extends StatelessWidget {
  const Giza_Pyramids_Inn({Key? key}) : super(key: key);
        ...
        child: ListView(
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://cf.bstatic.com/xdata/images/hotel/max500/279007538.jpg?k=fde7087ca82e834d2f279e874dc1dfc9441e594780eba0f4a7124380bc4c140d&o=&hp=1',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZCo4hITp1iUJbYTrBRUYH2tGgpEcS3pqM-teQHCEdo4ZjSp6Qg_3jYjNXXVKc1zLKZIY&usqp=CAU',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://cf.bstatic.com/xdata/images/hotel/max500/367192502.jpg?k=6c24261032446442b8cedc3bb030a8657a9826b14170d75276046ef2a0c7fcdc&o=&hp=1',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Container(child: Text("The Price : 3400 ",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),),
                ...
                child: Row(
                  children: [
                    IconButton(onPressed:(){
                      Navigator.push(context, MaterialPageRoute(builder: (_)=> Locationgi2()));
                    }, icon: Icon(Icons.location_on)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://www.facebook.com/gizapyramidsinnhotel/");
...
class Locationgi2 extends StatelessWidget {
  const Locationgi2({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(
            target: LatLng(29.97513838019303, 31.141048581341405),
            zoom: 18.0,
          ...
          markers: {
            const Marker(
              markerId: MarkerId("1"),
              position: LatLng(29.97513838019303, 31.141048581341405),
