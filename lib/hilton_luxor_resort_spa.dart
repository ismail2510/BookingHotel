...
class Hilton_Luxor_Resort_Spa extends StatelessWidget {
  const Hilton_Luxor_Resort_Spa({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Hilton Luxor Resort & Spa"),
      ),
        ...
        child: ListView(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Rooms : 500",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                    SizedBox(width: 73,),
                    Text("Travelers : 2600",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),)
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    Container(child: Text("The Price : 3000 ",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),),
    ...
    return Scaffold(
      body: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(
            target: LatLng(25.7304253669851, 32.65662401477378),
            zoom: 18.0,
          ...
          markers: {
            const Marker(
              markerId: MarkerId("1"),
              position: LatLng(25.7304253669851, 32.65662401477378),
