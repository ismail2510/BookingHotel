...
class Sunrise_Alexandria_Avenue_Hotel extends StatelessWidget {
  const Sunrise_Alexandria_Avenue_Hotel({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Sunrise Alexandria Avenue Hotel"),
      ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://exp.cdn-hotels.com/hotels/43000000/42580000/42575000/42574953/c4d76b4a_z.jpg?impolicy=fcrop&w=500&h=333&q=medium',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSN_HgkJneGMHwuklJTMNqKZjH_lWbaDiad1mPtDZxOdF5TIr0roI4slXtBpV3wQY5NB0Y&usqp=CAU'
                            ),
                            fit: BoxFit.fill),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://www.facebook.com/SUNRISEAlexAvenue/");
                      //https://m.facebook.com/profile.php?id=139340932872218&__tn__=C-R
                    }, icon: Icon(Icons.facebook)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("tel:01003200083");
                      //02 24619494
