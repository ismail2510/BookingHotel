...
class Tolip_Alexandria extends StatelessWidget {
  const Tolip_Alexandria({Key? key}) : super(key: key);
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/89/41/04/outdoor-swimming-pool.jpg?w=700&h=-1&s=1'
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://exp.cdn-hotels.com/hotels/7000000/6780000/6771300/6771287/7ea22beb_z.jpg?impolicy=fcrop&w=500&h=333&q=medium',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://cf.bstatic.com/xdata/images/hotel/max500/288998939.jpg?k=fe3d937165e6af00fe2cd9fad1285195309b9d5d70c5f72df010c82d29a43d25&o=&hp=1'
                            ),
                            fit: BoxFit.fill),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://ar-ar.facebook.com/TolipHotelAlexandria/");
                      //https://m.facebook.com/profile.php?id=139340932872218&__tn__=C-R
                    }, icon: Icon(Icons.facebook)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("tel:035419330");
                      //02 24619494
