...
class Hilton_Alexandria_Green_Plaza extends StatelessWidget {
  const Hilton_Alexandria_Green_Plaza({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Hilton Alexandria Green Plaza"),
      ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://weekender-hotel-api-2.imgix.net/hotel-images/20170206-ALYGPHI-hotel-banner-1.jpg?auto=format&crop=entropy&fit=crop&h=230&q=50&w=372'
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://q-xx.bstatic.com/xdata/images/hotel/max500/313054815.jpg?k=883a2916de535b2f58b97795cd6726f71ddd72c2c9823669e9424b684885a4fd&o='
                            ),
                            fit: BoxFit.fill),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://ar-ar.facebook.com/hiltongreenplaza/");
                      //https://m.facebook.com/profile.php?id=139340932872218&__tn__=C-R
                    }, icon: Icon(Icons.facebook)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("tel:034209120");
                      //02 24619494
