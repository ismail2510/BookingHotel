...
class Sonesta_St_George extends StatelessWidget {
  const Sonesta_St_George({Key? key}) : super(key: key);
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0f/48/b4/04/hotel-pool.jpg?w=700&h=-1&s=1'
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://content.r9cdn.net/rimg/himg/f7/14/09/ice-50812-98513694-877571.jpg?width=500&height=350&xhint=1555&yhint=960&crop=true',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                              'https://p.bookcdn.com/data/Photos/380x175/12312/1231299/1231299821/Sonesta-St-George-Hotel-Convention-Center-photos-Exterior-Sonesta-St-George-Hotel-Convention-Center.JPEG',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("https://ar-ar.facebook.com/SonestaHotelLuxor/");
                      //https://m.facebook.com/profile.php?id=139340932872218&__tn__=C-R
                    }, icon: Icon(Icons.facebook)),
                    SizedBox(width: 10,),
                    IconButton(onPressed:(){
                      launch("tel:0952382575");
                      //02 24619494
    ...
    return Scaffold(
      body: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(
            target: LatLng(25.688676067072514, 32.63130489759554),
            zoom: 18.0,
          ...
          markers: {
            const Marker(
              markerId: MarkerId("1"),
              position: LatLng(25.688676067072514, 32.63130489759554),
